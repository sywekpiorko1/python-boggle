...
class TetBoggle(unittest.TestCase):
    """
    ...
    def test_grid_size_is_wiwidth_time_height(self):
        """
    ...
    def test_grid_coordinates(self):
        """
        Tett to ensure that all of the coordinates
    ...
    def test_neighbours_of_a_position(self):
        """
        Ensure that position has 8 neighbours
        """
        coords = (1,2)
        neighbours = boggle.neighbours_of_positon(coords)
    ...
    def test_load_dictionary(self):
        """
        Test that the 'get_dictionary' function returns a dictonary
